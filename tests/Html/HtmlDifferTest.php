...
HTML;
    ...
    public function testSimpleTextRemoveWithAncestor(): void
    {
        ...
        $expected = <<<HTML
<p> This is a <ins class="diff-html-added">blue </ins><del class="diff-html-removed">big blue </del>book</p>
HTML;
...
HTML;
    ...
    public function testSimpleAttributeAddWithAncestor(): void
    {
        ...
        $expected = <<<HTML
<p class="example"><span class="diff-html-changed"> </span><span class="diff-html-changed">This is a blue book</span></p>
HTML;
...
HTML;
    ...
    public function testTagAddWithAncestor(): void
    {
        ...
        $expected = <<<HTML
<span class="diff-html-changed">This is a </span><b><span class="diff-html-changed">blue</span></b><span class="diff-html-changed"> book</span>
HTML;
...
HTML;
    ...
    {
        $this->markTestIncomplete('This appears to not work as expected.');
